...
```json
{
  ...
  "temp_label": "Temperarura",
  "temp_value": "38°C",
  "lluvia_label": "Lluvia",
  "lluvia_value": "38%",
  "viento_label": "Viento",
  "viento_value": "31 km/h",
  "hum_label": "Humedad",
  "hum_value": " 93-96%"
}
```
...
|-------|----|-------------|
| `titulo` | `.titulo` | ESTADO DEL TIEMPO |
| `temp_label` | `.temp_label` | Temperarura |
| `temp_value` | `.temp_value` | 38°C |
| `lluvia_label` | `.lluvia_label` | Lluvia |
| `lluvia_value` | `.lluvia_value` | 38% |
| `viento_label` | `.viento_label` | Viento |
| `viento_value` | `.viento_value` | 31 km/h |
| `hum_label` | `.hum_label` | Humedad |
| `hum_value` | `.hum_value` |  93-96% |
